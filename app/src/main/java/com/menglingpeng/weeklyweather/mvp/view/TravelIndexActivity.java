...
public class TravelIndexActivity extends BaseActivity implements IWXAPIEventHandler{
    ...
    protected void initLayoutId() {
        layoutId = R.layout.activity_travel_index;
    }
    ...
    protected void initViews() {
        ...
        toolbar = (Toolbar)findViewById(R.id.travel_index_tb);
        tabLayout = (TabLayout)findViewById(R.id.travel_index_tl);
        viewPager = (ViewPager)findViewById(R.id.travel_index_vp);
        titles = new ArrayList<>();
        fragments = new ArrayList<>();
        toolbar.setTitle(R.string.travel_index);
