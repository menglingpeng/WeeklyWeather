...
public class ComfortIndexActivity extends BaseActivity implements IWXAPIEventHandler{
    ...
    protected void initLayoutId() {
        layoutId = R.layout.activity_comfort_index;
    }
    ...
    protected void initViews() {
        ...
        toolbar = (Toolbar)findViewById(R.id.comfort_index_tb);
        tabLayout = (TabLayout)findViewById(R.id.comfort_index_tl);
        viewPager = (ViewPager)findViewById(R.id.comfort_index_vp);
        titles = new ArrayList<>();
        fragments = new ArrayList<>();
        toolbar.setTitle(R.string.comfort_index);
