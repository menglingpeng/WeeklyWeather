...
/**
 * Created by mengdroid on 2018/5/22.
 */

public class ThreeChartGestureListener implements OnChartGestureListener {

    private Chart srcChart;
    private Chart[] dstCharts;

    public ThreeChartGestureListener(Chart srcChart, Chart[] dstCharts){
